...
public class SellerFormController implements Initializable {
	...
	private Seller getFormData() {
		...
		if (txtName.getText() == null || txtName.getText().trim().equals("")) {
			exception.addErrors("nome", "campo nao pode ser vazio");
		}
		obj.setName(txtName.getText());
		
		if (txtEmail.getText() == null || txtEmail.getText().trim().equals("")) {
			exception.addErrors("email", "campo nao pode ser vazio");
		}
		obj.setEmail(txtEmail.getText());
		
		if(dpBirthDate.getValue() == null) {
			exception.addErrors("data", "campo nao pode ser vazio");
		}
		else {
		...
		if (txtBaseSalary.getText() == null || txtBaseSalary.getText().trim().equals("")) {
			exception.addErrors("salario", "campo nao pode ser vazio");
		}
	...
	public void updateFormData() {
		...
		if(entity.getDepartment() == null) {
			...
			this.comboBoxDepartment.setValue(entity.getDepartment());
		}
	}
	...
	private void setErrorMessages(Map<String, String> errors) {
		...
		errorName.setText((fields.contains("nome") ? errors.get("nome") : ""));
		errorEmail.setText((fields.contains("email") ? errors.get("email") : ""));
		errorBirthDate.setText((fields.contains("data") ? errors.get("data") : ""));
		errorBaseSalary.setText((fields.contains("salario") ? errors.get("salario") : ""));
	}
